...
const urlFor = (applicationId, gatewayId) => {
    let str = `/api/1/applications/${applicationId}/gateways`;
    if(gatewayId){
        str += `/${gatewayId}`;
    }
    return str;
...
class GatewayEditForm extends Component {
    constructor(props){
        super(props);
        this.state = {
            id: props.gateway.id || undefined,
            active: _.isNull(props.gateway.active) ? true : props.gateway.active,
            name: props.gateway.name || undefined,
            checkinFrequency: props.gateway.checkinFrequency || 30,
                    ...
                    <form className="form-inline gateway-edit">
                        <div className="form-group">
                            ...
                            <input id="inputId" type="text"
                                   ...
                                   defaultValue={this.state.id} disabled={!_.isEmpty(this.props.gateway.id)}
